            ...
            <div className="md:hidden py-4 border-t border-gray-200">
              <nav className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3 pt-4 border-t border-gray-200">
                  <button
                    onClick={() => openAuth('login')}
                    className="px-4 py-2 text-gray-700 hover:text-gray-900 transition-colors text-left"
                  >
                    Log in
                  </button>
                  <button
      ...
      {showAuthModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-8 relative">
            ...
            {/* Google Sign In */}
            <button className="w-full py-3 px-4 border-2 border-gray-300 rounded-lg hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-3 mb-6">
